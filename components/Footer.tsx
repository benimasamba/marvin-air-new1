...
const SocialLink = ({ href, srText, icon }: { href: string; srText: string; icon: React.ReactNode }) => (
    ...
    <footer className="bg-text-primary text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <p className="text-2xl font-bold">Marvin Air</p>
          <p className="mt-2 text-base text-gray-400">1801 NW 22nd St Miami, FL 33142 | (305) 541-8408</p>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 text-sm text-gray-400 md:flex md:items-center md:justify-between">
            <div className="flex justify-center space-x-6 md:order-2">
              <a className="hover:text-white" href="#">Privacy Policy</a>
              <a className="hover:text-white" href="#">Terms of Service</a>
            </div>
            <p className="mt-8 md:mt-0 md:order-1">© {new Date().getFullYear()} Marvin Air. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
